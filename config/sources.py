...
_SOURCE_ROWS = [
    ...
    ("misa", "MISA — Ministry of Investment", "https://misa.gov.sa/en", "open", "T1", ["P1", "P2", "P4"]),
    ("investsaudi", "Invest Saudi", "https://investsaudi.sa/en", "open", "T1", ["P1", "P2", "P4"]),
    ("mim", "MIM — Ministry of Industry & Mineral Resources", "https://www.mim.gov.sa/en", "open", "T1", ["P1", "P2"]),
    ("pif", "PIF — Public Investment Fund", "https://www.pif.gov.sa/en", "open", "T1", ["P1"]),
    ("ecza", "ECZA — Special Economic Zones", "https://ecza.gov.sa/en", "open", "T1", ["P1", "P2"]),
    ("monshaat", "Monshaat — SME Authority", "https://www.monshaat.gov.sa/en", "saudi_ip", "T1", ["P2"]),
    ("svc", "SVC — Saudi Venture Capital", "https://www.svc.com.sa/en", "open", "T1", ["P1", "P2"]),
    ...
    ("hrsd", "HRSD — Human Resources & Social Development", "https://hrsd.gov.sa/en", "open", "T1", ["P2", "P4", "P6"]),
    ("sta", "Saudi Tourism Authority (STA)", "https://www.sta.gov.sa/en/home", "saudi_ip", "T1", ["P3"]),
    ("visitsaudi", "Visit Saudi", "https://www.visitsaudi.com/en", "open", "T1", ["P3", "P4"]),
    ("mt", "Ministry of Tourism", "https://mt.gov.sa/en", "saudi_ip", "T1", ["P3"]),
    ("vision2030", "Vision 2030 Portal", "https://www.vision2030.gov.sa/en", "open", "T1", ["P1", "P2", "P4", "P5"]),
    ("datasaudi", "DataSaudi (Statistics)", "https://datasaudi.sa/en", "open", "T1", ["P1", "P2", "P3", "P4"]),
    ("nusuk", "Nusuk (Pilgrimage Logistics)", "https://nusuk.sa", "open", "T1", ["P3"]),
    ...
    ("moe", "Ministry of Education", "https://moe.gov.sa/en", "open", "T1", ["P5", "P6"]),
    ("moh", "Ministry of Health (MoH)", "https://www.moh.gov.sa/en", "open", "T1", ["P6"]),
    ("zatca", "ZATCA — Zakat, Tax & Customs Authority", "https://zatca.gov.sa/en", "open", "T1", ["P1", "P2", "P6"]),
    ...
    ("diriyah", "Diriyah Gate", "https://www.diriyah.sa/en", "open", "T2", ["P3"]),
    ...
    ("kafd", "KAFD — King Abdullah Financial District", "https://www.kafd.sa/en", "open", "T2", ["P1", "P4"]),
    # Tier 3 — universities
